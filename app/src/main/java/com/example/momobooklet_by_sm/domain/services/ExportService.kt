package com.example.momobooklet_by_sm.domain.services
...
object ExportService {
    ...
    fun exportPdf(type: PdfConfigImpl, content: TransactionTablePDFManager, content2: DailyCommissionModelPDFManager): Flow<Boolean> =
