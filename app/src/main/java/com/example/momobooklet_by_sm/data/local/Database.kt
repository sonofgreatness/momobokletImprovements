package com.example.momobooklet_by_sm.data.local
...
import com.example.momobooklet_by_sm.data.local.models.*
...
@Database
    ...
    companion object {
        ...
        private var INSTANCE: com.example.momobooklet_by_sm.data.local.Database? = null
        fun getDatabase(context: Context): com.example.momobooklet_by_sm.data.local.Database {
            ...
            synchronized(this) {
                val instance = Room.databaseBuilder(
                    ...
                    com.example.momobooklet_by_sm.data.local.Database::class.java,
                    "user_database.db"
                )
