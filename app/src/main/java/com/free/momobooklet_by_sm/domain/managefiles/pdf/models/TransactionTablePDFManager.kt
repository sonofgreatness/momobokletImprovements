...
class TransactionTablePDFManager(
   ...
   private val headerTextProperties = TextProperties().apply {
                                    textSize = Constants.PDF_TABLE_TEXT_HEADER_SIZE
                                    textColor = Constants.PDF_TABLE_HEADER_TEXT_COLOR
                                   }

    private val imageProperties =  ImageProperties().apply {
   ...
   fun tableRowsMaker(): LinkedList<LinkedList<Cell>> {
        ...
        val titleRow =  LinkedList<Cell>().apply {
            ...
            add(TextCell(Constants.TRANSACTIONCOLUMNTITLE_2, headerTextProperties, column2_width))
            add(TextCell(Constants.TRANSACTIONCOLUMNTITLE_3, headerTextProperties, column3_width))
            add(TextCell(Constants.TRANSACTIONCOLUMNTITLE_4, headerTextProperties, column4_width))
            add(TextCell(Constants.TRANSACTIONCOLUMNTITLE_5, headerTextProperties, column5_width))
            add(TextCell(Constants.TRANSACTIONCOLUMNTITLE_6, headerTextProperties, column6_width))
            add(TextCell(Constants.TRANSACTIONCOLUMNTITLE_7, headerTextProperties, column7_width))
            add(TextCell(Constants.TRANSACTIONCOLUMNTITLE_8, headerTextProperties, column8_width))
        }
