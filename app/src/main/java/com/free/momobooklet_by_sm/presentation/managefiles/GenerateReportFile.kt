...
import com.free.momobooklet_by_sm.databinding.FragmentGenerateReportFileBinding
import com.free.momobooklet_by_sm.MainActivity
import com.free.momobooklet_by_sm.common.util.classes.FileFormatType
...
class GenerateReportFile : Fragment() {
    ...
    private  lateinit var  mGenerateReportViewModel: GenerateReportViewModel
    ...
    override fun onCreateView(
        ...
        mGenerateReportViewModel = (activity as MainActivity).mGenerateReportViewModel
                ...
                if (fileFormat != null) {
                    ...
                    if (startDate != null) {
                        ...
                        for (type in listOfReportTypes)
                        {
                            ...
                            mGenerateReportViewModel.writeReport(startDate!!, type)
                            Timber.d("type count $i -> ${type.name}")
                            i++
                        }
    ...
    private fun getDatePicked(dayOfMonth: Int, month: Int, year: Int):String {
        return mGenerateReportViewModel.datesManager
