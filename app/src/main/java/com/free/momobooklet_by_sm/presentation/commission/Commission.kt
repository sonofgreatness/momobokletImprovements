package com.free.momobooklet_by_sm.presentation.commission
...
import com.free.momobooklet_by_sm.databinding.FragmentCommissionBinding
...
class Commission : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        mCommissionViewModel.setTodayCommission()
        mCommissionViewModel.setYesterDayCommission()
        mCommissionViewModel.setLastMonthCommission()
        mCommissionViewModel.setThisMonthCommission()
    ...
    private fun writeData(starDate: String) {
     ...
     *@param datePicked , The date picked by the user,since dailCommission?
    ...
    private fun setCustomDailyCommission(dayOfMonth: Int, month: Int, year: Int) {
               val date = getDatePicked(dayOfMonth, month, year)
                    mCommissionViewModel.setCustomDayCommission(date)
    }
